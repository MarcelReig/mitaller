...
class ArtistProfile(models.Model):
    ...
    Cada artesano tiene una URL única basada en slug: /artistas/{slug}/
    """
    ...
    # Identificación y visibilidad pública
    slug = models.SlugField(
        _('slug'),
        max_length=100,
        unique=True,
        help_text=_('URL única del artesano: /artistas/{slug}/')
    )
    ...
    bio = models.TextField(
        _('biografía'),
        blank=True,
        help_text=_('Descripción del artesano y su trabajo')
    )
    ...
    def instagram_url(self) -> str | None:
        ...
        Ejemplo: "https://instagram.com/juan_ceramista"
        """
        if self.instagram:
