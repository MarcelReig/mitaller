# Generated by Django 5.0.1 on 2025-10-12 13:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist', models.ForeignKey(help_text='Artesano creador de esta obra', on_delete=django.db.models.deletion.CASCADE, related_name='works', to='artists.artistprofile', verbose_name='artesano')),
            ],
            options={
                'verbose_name': 'Obra',
                'verbose_name_plural': 'Obras',
                'ordering': ['artist', 'display_order', '-created_at'],
                'indexes': [models.Index(fields=['artist', 'display_order'], name='works_work_artist__9cc39e_idx'), models.Index(fields=['category'], name='works_work_categor_2675d5_idx'), models.Index(fields=['is_featured', '-created_at'], name='works_work_is_feat_86bf57_idx')],
            },
        ),
    ]
